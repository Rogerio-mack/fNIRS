# -*- coding: utf-8 -*-
"""rectify_snirf_v2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xLhUVtpnICaGgQQRKMt8oG9d-N98UYAR
...
df_aux =  pd.DataFrame({'time':[],'aux_name':[]})

for a in aux_list:
  
  data['nirs'][a]['dataTimeSeries'][:]

data['nirs']['aux1']['dataTimeSeries'][:][ data['nirs']['aux1']['dataTimeSeries'][:] != 0 ]
...
"""# Corrige 27o e 28o estímulos

* De 27o $\rightarrow$ 4 para  27o $\rightarrow$ 1
* De 28o $\rightarrow$ 3 para  28o $\rightarrow$ 4

Note acima que os estímulos são indexados a partir do zero, portanto o 27o estímulo corresponde ao índice 26, e o 28o ao índice 27. Esses os elementos que serão trocados.
"""

df_temp[df_temp.stim_ == 'stim1']

"""## Corrindo no Data Frame"""

df_temp.groupby('stim_').stim_.count()

print(df_temp.at[26,'stim_'],df_temp.at[27,'stim_'])

df_temp.at[26,'stim_'] = 'stim1'
df_temp.at[27,'stim_'] = 'stim4'
...
data['nirs']['stim4']['data'][:]

df_temp[df_temp.stim_ == 'stim4']

stim_new = np.c_[ np.array(df_temp[df_temp.stim_ == 'stim4']['start']).T , np.ones(5).T * 18 , np.ones(5).T * 5 ] 

del data['nirs']['stim4']['data']
data['nirs']['stim4'].create_dataset('data', data=stim_new)
data['nirs']['stim4']['data'][:]

data['nirs']['stim3']['data'][:]

df_temp[df_temp.stim_ == 'stim3']

stim_new = np.c_[ np.array(df_temp[df_temp.stim_ == 'stim3']['start']).T , np.ones(5).T * 18 , np.ones(5).T * 5 ] 
